...
手机优先的简体中文人民币 PWA，用于个人记录“我欠别人”和“别人欠我”的债务、还款及到期信息。金额在客户端输入为元，数据库按分（整数）保存。
...
3. 在 Supabase Auth 中启用 Email，并把本地/生产地址加入 Redirect URLs。
...
- 魔法链接和真实跨设备同步必须连接用户自己的 Supabase 项目后验证。
