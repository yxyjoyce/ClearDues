...
import { ArrowDownLeft, ArrowRight, ArrowUpRight, CalendarDays, Check, ChevronRight, Cloud, CloudOff, CreditCard, Moon, Pencil, Plus, ReceiptText, Settings, Sun, Trash2, X } from 'lucide-react'
...
import { calculateStats, debtOccurredDate, filterDebtsByMonth, filterRepaymentsThroughMonth, remainingCents } from './stats'
...
function DebtDetailsCard({ groups }: { groups: DebtGroup[] }) {
